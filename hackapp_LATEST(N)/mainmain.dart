...
//             child: Column(
//               children: [
//                 const Spacer(flex: 5), // Push the form even lower
//                 TextField(
//                   controller: emailController,
//                   decoration: InputDecoration(
//                     labelText: 'Email',
...
//                   child: const Text('Sign Up'),
//                 ),
//                 const Spacer(flex: 1), // Maintain a little space below
//               ],
//             ),
//           ),
//         ],
      ...
      body: Stack(
        children: [
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('lib/pics/Logo.jpg'),
                  fit: BoxFit.contain,
                ),
              ),
            ),
          ...
          Padding(
            ...
            child: Column(
              children: [
                const Spacer(flex: 5), // Push the form lower
                TextField(
                  controller: emailController,
...
//           Positioned.fill(
//             child: Image.asset(
//               'lib/pics/bac.jpg', // Path to your image
      ...
      body: Stack(
        children: [
          ...
          Align(
            ...
            child: Container(
              width: MediaQuery.of(context).size.width * 0.8, // Scale down width
              height: MediaQuery.of(context).size.height * 0.8, // Scale down height
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage('lib/pics/bac.jpg'),
                  fit: BoxFit.contain, // Contain the image within the container
                ),
              ),
            ),
          ),
